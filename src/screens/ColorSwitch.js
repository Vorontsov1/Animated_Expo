    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, padding: SPACING }}>
        ...
        <MyText
          from={from}
          to={to}
          style={{ fontSize: 28, fontWeight: "800", marginBottom: SPACING * 6 }}
        >
          Setup a meeting {"\n"}with Catalin
        </MyText>
        ...
        <MyText
          from={from}
          to={to}
          style={{ marginBottom: SPACING, fontWeight: "700" }}
        >
          Location
        </MyText>
        <MyText from={from} to={to} style={{ opacity: 0.7 }}>
          localhost:3000
        </MyText>
        <Separator from={from} to={to} />
        <MyText
      ...
      >
        <MyText from={from} to={to}>
          Random Color
        </MyText>
        <MyText
          from={from}
          to={to}
          style={{ fontFamily: "Menlo", opacity: 0.6 }}
        >
          Built with{" "}
          <MyText from={from} to={to} style={{ fontWeight: "900" }}>
            Moti
          </MyText>{" "}
          by{" "}
          <MyText style={{ fontWeight: "900" }} from={from} to={to}>
            @mironcatalin
          </MyText>
        </MyText>
      </Pressable>
